def market():
    ...
    print(
        "Bandits:'Stop right there you dimwits! This section of road blongs to us! A fee of 20g is needed to cross!!!")
    ...
    if UserInput == "1" and CH1 > 18:
        ...
        print(
            ":As he trys to recover you look in time to see %s has already defeated the other and now turned to finish the last of them!:" % stranger)
        medic_hall()
    else:
    ...
    if UserInput == "3":
        print(
            ":In the chaos you start crying! Filled with laughter the Bandit lands a blow across your face, knocking you out.:")
